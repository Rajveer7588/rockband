        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-30">
                    <div class="section-subtitle white">Help</div>
                    <div class="section-title white">Related <span class="white">Questions</span></div>
                ...
                <div class="col-md-6">
                    <ul class="accordion-box clearfix">
                        <li class="accordion block">
                            <div class="acc-btn">Getting Start</div>
                            <div class="acc-content">
                                <div class="content">
                                    ...
                                    <a href="over-view.php">Read More</a>
                                </div>
                            </div>
                        </li>
                        <li class="accordion block">
                            <div class="acc-btn">Connecting to Social Media</div>
                            <div class="acc-content">
                                <div class="content">
                                    <div class="text">Wedding aliquet orci elit gene tristique in lorem dream vitanem alisuam tincidunten felis sedat bir ravida alisuam neque liberta hendrerit manas the amentane the mollis erase.</div>
                                    <a href="over-view.php">Read More</a>
                        ...
                        <li class="accordion block">
                            <div class="acc-btn">Location</div>
                            <div class="acc-content">
                                <div class="content">
                                    <div class="text">Wedding aliquet orci elit gene tristique in lorem dream vitanem alisuam tincidunten felis sedat bir ravida alisuam neque liberta hendrerit manas the amentane the mollis erase.</div>
                                    <a href="over-view.php">Read More</a>
                        ...
                        <li class="accordion block">
                            <div class="acc-btn">Following and Unfollowing</div>
                            <div class="acc-content">
                                <div class="content">
                                    <div class="text">Wedding aliquet orci elit gene tristique in lorem dream vitanem alisuam tincidunten felis sedat bir ravida alisuam neque liberta hendrerit manas the amentane the mollis erase.</div>
                                    <a href="over-view.php">Read More</a>
                        ...
                        <li class="accordion block">
                            <div class="acc-btn">Troubleshooting</div>
                            <div class="acc-content">
                                <div class="content">
                                    <div class="text">Wedding aliquet orci elit gene tristique in lorem dream vitanem alisuam tincidunten felis sedat bir ravida alisuam neque liberta hendrerit manas the amentane the mollis erase.</div>
                                    <a href="over-view.php">Read More</a>
                        ...
                        <li class="accordion block">
                            <div class="acc-btn">Bandsintown Live Stream</div>
                            <div class="acc-content">
                                <div class="content">
                                    <div class="text">Wedding aliquet orci elit gene tristique in lorem dream vitanem alisuam tincidunten felis sedat bir ravida alisuam neque liberta hendrerit manas the amentane the mollis erase.</div>
                                    <a href="over-view.php">Read More</a>
                        ...
                        <li class="accordion block">
                            <div class="acc-btn">Artist Help</div>
                            <div class="acc-content">
                                <div class="content">
                                    <div class="text">Wedding aliquet orci elit gene tristique in lorem dream vitanem alisuam tincidunten felis sedat bir ravida alisuam neque liberta hendrerit manas the amentane the mollis erase.</div>
                                    <a href="over-view.php">Read More</a>
                        ...
                        <li class="accordion block">
                            <div class="acc-btn">Venue Help</div>
                            <div class="acc-content">
                                <div class="content">
                                    <div class="text">Wedding aliquet orci elit gene tristique in lorem dream vitanem alisuam tincidunten felis sedat bir ravida alisuam neque liberta hendrerit manas the amentane the mollis erase.</div>
                                    <a href="over-view.php">Read More</a>
                        ...
                        <li class="accordion block">
                            <div class="acc-btn">Promoter  Help</div>
                            <div class="acc-content">
                                <div class="content">
                                    <div class="text">Wedding aliquet orci elit gene tristique in lorem dream vitanem alisuam tincidunten felis sedat bir ravida alisuam neque liberta hendrerit manas the amentane the mollis erase.</div>
                                    <a href="over-view.php">Read More</a>
                        ...
                        <li class="accordion block">
                            <div class="acc-btn">Festival Help</div>
                            <div class="acc-content">
                                <div class="content">
                                    <div class="text">Wedding aliquet orci elit gene tristique in lorem dream vitanem alisuam tincidunten felis sedat bir ravida alisuam neque liberta hendrerit manas the amentane the mollis erase.</div>
                                    <a href="over-view.php">Read More</a>
