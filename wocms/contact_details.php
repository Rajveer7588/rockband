  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <form method="post" action="">
        ...
        <input type="text" name="contact_name" class="form-control" id="contact_name" placeholder="Heading" value="<?php echo @$contact_name ?>">
        </div>-->
          <div class="form-group">
        ...
        <div class="form-group">
        <label for="exampleInputEmail1"><i class="fa fa-envelope-o" aria-hidden="true"></i> More Email</label>
        <input type="email" name="contact_email1" class="form-control" id="contact_email1" placeholder="More Email" value="<?php echo @ $contact_email1?>">
        </div>
          <div class="form-group">
        ...
        <input type="text" name="contact_phone" class="form-control" id="contact_phone" placeholder="Phone" value="<?php echo @$contact_phone ?>">
          ...
          <div class="form-group">
        <label for="exampleInputEmail1"><i class="fa fa-phone" aria-hidden="true"></i> More Phone</label>
        <input type="text" name="contact_phone1" class="form-control" id="contact_phone1" placeholder="More Phone" value="<?php echo @$contact_phone1 ?>">
        </div>
          <div class="form-group">
        <label for="exampleInputEmail1"><i class="fa fa-map-signs" aria-hidden="true"></i> Address</label>
        <input type="text" name="contact_addr" class="form-control" id="contact_addr" placeholder="Address" value="<?php echo @$contact_addr ?>">
        </div>
        ...
        <div class="cont">
        <div class="form-group">
        <label for="exampleInputEmail1"><i class="fa fa-sticky-note-o" aria-hidden="true"></i> Content</label>
    
        </div>
        </div>
         <div class="editor">
        <textarea class="ckeditor" name="contact_content"><?php echo @$contact_content ?></textarea>
        </div>
          </div>-->
        <div class="col-md-5">
        <!--<div class="row">
...
if(isset($_POST['contact_submit']))
{
	...
	if($row==0)
	{
		...
		$insert = mysqli_query($conn,"INSERT into contact_details(admin_id,contact_name,contact_email,contact_email1,	contact_phone,contact_phone1,contact_addr,contact_content,map_longitude,map_latitude,contact_det_insert_date,contact_det_ip) VALUES('".$admin_id."','".$contact_name."','".$contact_email."','".$contact_email1."','".$contact_phone."','".$contact_phone1."','".$contact_addr."','".$contact_content."','".$map_longitude."','".$map_latitude."', now() ,'".$ip."')");
	...
	if($row>0)
	{
	   // echo "UPDATE contact_details SET contact_name='".$contact_name."', contact_email='".$contact_email."', contact_email1='".$contact_email1."', contact_phone='".$contact_phone."',contact_phone1='".$contact_phone1."', contact_addr='".$contact_addr."', contact_content='".$contact_content."', map_longitude='".$map_longitude."', map_latitude='".$map_latitude."', contact_det_update_date=now() , contact_det_ip='".$ip."' WHERE contact_id='".$loop['contact_id']."' AND admin_id='".$admin_id."'";
