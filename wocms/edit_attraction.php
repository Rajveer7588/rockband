    ...
    <section class="content-header">
      ...
      <form method="post" action="" enctype="multipart/form-data">
                ...
                <?php 
                  if(@$f_img==""){ 
                    ...
                    <?php
                      ...
                      ?>
                        <img src="../uploads/front_attraction/<?php echo @$f_img ?>">
                    <?php 
                  } 
                ?>
        ...
        <div class="form-group">
          ...
          <input type="text" name="f_caption" class="form-control" id="f_caption" placeholder="Image Caption" value="<?php echo html_entity_decode(@$f_caption) ;?>" />
        </div>
