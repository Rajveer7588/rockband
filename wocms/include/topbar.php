...
$(document).ready(function() {
	...
	$.ajax({
  method: "POST",
  url: ur+"admin/ajax/notification.php",
  cache: false,
...
<header class="main-header">
   ...
   <!-- rotateIn / rotateOut -->
         <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php if($list_count==0){echo "Notification" ;} else{ echo "Notifications";} ?> <span class="badge" id="not-count" data-seq="<?php echo @$list_count;?>"> <?php echo @$list_count;?></span>
                    </a>
					...
					?>
                      <li><a href="javascript:;" class="btn btn-info btn-lg raj" data-toggle="modal" data-target="#<?php echo @$list ;?>" data-url="<?php echo SITE_URL ;?>" data-admin="<?php echo $_SESSION['admin_id'] ;?>"><?php echo @$listing; ?></a></li>
                      <?php 
					  }
						}
					  		else
                ...
                <?php if(@$profile_img==""){ ?>
                  ...
                  <img src="framework/img/user2-160x160.jpg" class="user-image" alt="User Image">
                   ...
                   <?php }else{ ?>
      				...
      				<img src="../uploads/profile/<?php echo @$profile_img ;?>" class="user-image" alt="User Image">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      ...
                      <a href="logout.php" class="btn btn-default btn-flat"><i class="fa fa-sign-out" aria-hidden="true"></i>
