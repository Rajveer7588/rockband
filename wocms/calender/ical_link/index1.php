	...
	for ($i = 1; $i <= count($events); $i++) {
	   ...
	   $booking[] = $start_date.",".$end_date.",".$pro_id.",".$admin_id;
		...
		$query .= "'".mysqli_real_escape_string($link,$pro_id)."', ";
                $query .= "'".mysqli_real_escape_string($link,$cat)."', ";
...
$ical11 = mysqli_query($conn, "SELECT link FROM ical_links WHERE property_id='".$property_id."' AND admin_id='".$adm_id."'");
