...
$start= ($page - 1) * $per_page; //start list of user from zero becoz php starts from zero
 ...
 $fetch11 = mysqli_query($conn,"SELECT * FROM client_details WHERE property_id='".$myVar."' AND admin_id='".$admin_id."'  ORDER BY client_id DESC LIMIT $start, $per_page");
	   ...
	   {
 ?>
  <table class="table" align="center" id="example1">
    <thead>
      <tr>
	...
	?>
      <tr>
      	...
      	<td style="display:none;"><?php echo $client_id; ?></td>
        ...
        <!--<form action="edit_cal_date.php" method="post">-->
        <!--<td data-title="Edit" ><input type="hidden" name="edit_property" value="<?php echo @$client_id ; ?>"><button type="submit" name="edit_pro_button"><i class="fa fa-pencil"></i></button></td>-->
        <!--</form>-->
  ...
  <script>
      $('#example1').Tabledit({
    url: 'edit_cal_date.php',
    columns: {
        identifier: [1, 'client_id'],
        editable: [[2, 'name'], [3, 'email'], [4, 'firstdate'], [5, 'lastdate']]
    }
});
  </script>
...
<form id="myform" method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                    	<input type="text" name="first" id="first-date" class="datepicker1" />
                    </div>
                </div>
                <div class="form-group">
                	<label class="col-md-4 col-md-offset-1">Last date</label>
                    <div class="col-md-8">
                    	<input type="text" name="last" id="last-date" class="datepicker1" />
                    </div>
                </div>
                <div class="form-group">
