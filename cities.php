...
<body>
    ...
    <!-- Header Banner -->
    <div class="banner-header2 section-padding valign bg-img bg-fixed" data-overlay-dark="3" data-background="uploads/slidebanner/city_banner2B.jpg">
        <div class="container">
            <div class="row">
    ...
    <!-- Blog -->
    <section class="city city-section-padding bg-green">
        <div class="container">
            <div class="col-md-12 col-sm-12 mb-60">
                <div class="row">
                    <div class="city_item">
                        <h2>Africa</h2>
                         <a href="">Cape Town, South Africa</a>
                         <a href="">Johannesburg, South Africa</a>
                    ...
                    <div class="city_item">
                        <h2>Asia</h2>
                         ...
                         <a href="">Dubai, UAE</a>
                         <a href="">Fukuoka, Japan</a>
                         <a href="">Hiroshima, Japan</a>
                         <a href="">Hong Kong</a>
